...
public class EmpSuggestServImpl implements EmpSuggestServ {
    ...
    public EmpSuggestDto update(UUID id, EmpSuggestCreateDto empSuggestCreateDto) {
        ...
        if (empSuggestCreateDto.getUserId() != null)
            curentEmpSuggest.setUser(userRepo.findById(empSuggestCreateDto.getUserId()).orElseThrow(() -> new RuntimeException("User not found")));
        if (empSuggestCreateDto.getSuggestion() != null)
            curentEmpSuggest.setSuggestion(empSuggestCreateDto.getSuggestion());
        if (empSuggestCreateDto.getAssessmentYear() != null)
            curentEmpSuggest.setAssessmentYear(empSuggestCreateDto.getAssessmentYear());
